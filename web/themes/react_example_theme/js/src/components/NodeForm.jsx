...
const fetchUrl = id ? '/Drupal-React-Prototype/web/jsonapi/node/article/${id}' : '/Drupal-React-Prototype/web/jsonapi/node/article';
  ...
  try {
    ...
    console.log('Error while contacting API');
    setSubmitting(false);
  }
};
